  ...
  return (
    <div className="mt-4">
      ...
      <ul className="mb-6">
        <li className="-mx-2">
          <button
            className="flex w-full items-center justify-between rounded bg-indigo-500/30 p-2"
          ...
          >
            ...
            <div className="ml-2 flex items-center">
              <div className="inline-flex rounded-full bg-indigo-400 px-2 text-center text-xs font-medium leading-5 text-white">
                2
              </div>
            </div>
          </button>
        ...
        <li className="-mx-2">
          <button
            className="flex w-full items-center justify-between rounded p-2"
            onClick={() => setFlyoutOpen(false)}
          >
            <div className="flex items-center truncate">
              <Image
