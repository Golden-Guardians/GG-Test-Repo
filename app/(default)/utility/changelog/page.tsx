...
import User01 from "@/app/images/user-32-01.jpg"
import User02 from "@/app/images/user-32-02.jpg"
import User07 from "@/app/images/user-32-07.jpg"
                  ...
                  <div className="grow border-b border-slate-200 pb-6 dark:border-slate-700">
                    <header>
                      ...
                      <div className="mb-4 flex flex-nowrap items-center space-x-2">
                        ...
                        <div>
                          <div className="inline-flex rounded-full bg-rose-100 px-2.5 py-1 text-center text-xs font-medium text-rose-500 dark:bg-rose-500/30 dark:text-rose-400">
                            Bug Fix
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="grow border-b border-slate-200 pb-6 dark:border-slate-700">
                    <header>
                      ...
                      <div className="mb-4 flex flex-nowrap items-center space-x-2">
                        ...
                        <div>
                          <div className="inline-flex rounded-full bg-sky-100 px-2.5 py-1 text-center text-xs font-medium text-sky-600 dark:bg-sky-500/30 dark:text-sky-400">
                            Exciting News
                          </div>
                        </div>
                      </div>
