export const metadata = {
  title: 'KnowledgeBase - Golden Guardians',
...
export default function KnowledgeBase() {
  return (
    <div className="relative h-full bg-white dark:bg-slate-900">
      {/* Search area */}
      <div className="relative flex flex-col items-center justify-center overflow-hidden bg-indigo-500 px-4 py-8 dark:bg-transparent dark:bg-gradient-to-b dark:from-indigo-500/70 dark:to-indigo-500/30 sm:px-6 lg:px-8 lg:py-16">
        {/* Glow */}
        <div className="pointer-events-none absolute" aria-hidden="true">
          <div className="h-64 w-64 rounded-full bg-white bg-opacity-30 blur-3xl dark:bg-opacity-10"></div>
        </div>
        {/* Illustration */}
        <div className="pointer-events-none absolute" aria-hidden="true">
        ...
        <div className="relative mx-auto w-full max-w-2xl text-center">
          <div className="mb-5">
            <h1 className="text-2xl font-bold text-white md:text-3xl">👋 What Can We Help You Find?</h1>
          </div>
          <form className="relative">
            <label htmlFor="action-search" className="sr-only">
              Search
            </label>
            <input id="action-search" className="form-input w-full py-3 pl-9 focus:border-slate-300 dark:border-slate-800 dark:bg-slate-800 dark:hover:border-slate-900 dark:focus:border-slate-900" type="search" />
      ...
      <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="mb-5">
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Popular Topics</h2>
            </div>
            {/* Grid */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:sidebar-expanded:grid-cols-2 xl:sidebar-expanded:grid-cols-4">

              {/* Item */}
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    {/* Icon */}
                    <div className="inline-flex h-12 w-12 rounded-full bg-indigo-400">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Getting Started</h3>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">In-app Messaging</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Apps &amp; Tools</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Billing &amp; Invoices</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Support</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Multimedia / Files</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">App Rewards</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
              ...
              <div className="rounded-sm bg-slate-100 p-5 text-center dark:bg-slate-800">
                <div className="flex h-full flex-col">
                  <div className="mb-2 grow">
                    ...
                    {/* Content */}
                    <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Contact Us</h3>
                    <div className="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                  </div>
                  {/* Link */}
                  <div>
          ...
          <div>
            <div className="mb-5">
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Popular Guides</h2>
            </div>
            {/* Grid */}
            <div className="grid gap-6 sm:grid-cols-2">

              {/* Item */}
              <div className="text w-full rounded-sm border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-800">
                <div className="flex h-full">
                  {/* Icon */}
                  <svg className="mr-3 mt-[3px] h-4 w-4 shrink-0 fill-indigo-500" viewBox="0 0 16 16">
                    <path d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm1 12H7V7h2v5zM8 6c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z" />
                  </svg>
                  <div className="flex h-full flex-col">
                    {/* Content */}
                    <div className="mb-2 grow">
                      <div className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Documents For Business Verification</div>
              ...
              <div className="text w-full rounded-sm border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-800">
                <div className="flex h-full">
                  ...
                  <div className="flex h-full flex-col">
                    {/* Content */}
                    <div className="mb-2 grow">
                      <div className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Delayed Or Missing Payouts</div>
                      <div className="text-sm">
                        Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.
                      </div>
                    </div>
              ...
              <div className="text w-full rounded-sm border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-800">
                <div className="flex h-full">
                  ...
                  <div className="flex h-full flex-col">
                    {/* Content */}
                    <div className="mb-2 grow">
                      <div className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Update Existing Bank Account Information</div>
                      <div className="text-sm">
                        Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.
                      </div>
                    </div>
              ...
              <div className="text w-full rounded-sm border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-800">
                <div className="flex h-full">
                  ...
                  <div className="flex h-full flex-col">
                    {/* Content */}
                    <div className="mb-2 grow">
                      <div className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Close A Golden Guardians Account</div>
                      <div className="text-sm">
                        Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.
                      </div>
                    </div>
