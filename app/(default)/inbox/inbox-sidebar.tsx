            ...
            <div className="flex h-16 items-center border-b border-slate-200 bg-white px-5 dark:border-slate-700 dark:bg-slate-900">
              <div className="flex w-full items-center justify-between">
                ...
                <button className="ml-2 shrink-0 rounded border border-slate-200 bg-white p-1.5 shadow-sm hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                  <svg
                    className="h-4 w-4 fill-current text-slate-500"
                    viewBox="0 0 16 16"
                  >
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button
                    className="flex w-full rounded bg-indigo-100 p-2 text-left dark:bg-indigo-500/30"
                  ...
                  >
                    ...
                    <div className="grow truncate">
                      ...
                      <div className="mb-0.5 truncate text-xs font-medium text-slate-800 dark:text-slate-100">
                ...
                <li className="-mx-2">
                  <button
                    className="flex w-full rounded p-2 text-left"
                    onClick={() => setFlyoutOpen(false)}
                  >
                    <Image
                      className="mr-2 h-8 w-8 rounded-full"
                    ...
                    <div className="grow truncate">
                      ...
                      <div className="mb-0.5 truncate text-xs font-medium text-slate-800 dark:text-slate-100">
                        🙌 Help us improve Golden Guardians by giving…
                      </div>
                      <div className="whitespace-normal text-xs">
                        Lorem ipsum dolor sit amet, consecte adipiscing elit
                        aute irure dolor…
