export const metadata = {
  title: 'Job Post - Golden Guardians',
  ...
  return (
    <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          <div className="mb-6">
            <Link className="btn-sm border-slate-200 bg-white px-3 text-slate-600 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600" href="/jobs">
          ...
          <div className="mb-2 text-sm italic text-slate-500 dark:text-slate-400">Posted Jan 6, 2022</div>
          <header className="mb-4">
            {/* Title */}
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">Senior Client Engineer (React &amp; React Native)</h1>
          </header>

          {/* Company information (mobile) */}
          <div className="mb-6 rounded-sm border border-slate-200 bg-white p-5 shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:hidden">
            <div className="mb-6 text-center">
              <div className="mb-3 inline-flex">
                <Image className="h-16 w-16 rounded-full" src={Image06} width={64} height={64} alt="Company 01" />
              </div>
              <div className="mb-1 text-lg font-bold text-slate-800 dark:text-slate-100">Revolut Ltd</div>
              <div className="text-sm italic text-slate-500 dark:text-slate-400">179 Jobs Posted</div>
            </div>
            <div className="space-y-2 sm:flex sm:space-x-2 sm:space-y-0">
              <button className="btn w-full bg-indigo-500 text-white hover:bg-indigo-600">Apply Today -&gt;</button>
              <button className="btn w-full border-slate-200 text-slate-600 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600">Company Profile</button>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="-m-1 flex flex-wrap items-center">
              <div className="m-1">
                <a className="inline-flex rounded-full bg-indigo-100 px-2.5 py-1 text-center text-xs font-medium text-indigo-600 dark:bg-indigo-500/30 dark:text-indigo-400" href="#0">
                  Full-time
                </a>
              </div>
              <div className="m-1">
          ...
          {/* The Role */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">The Role</h2>
          ...
          {/* About You */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">About You</h2>
            <div className="space-y-6">
              <p>
          ...
          {/* Things You Might Do */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Things You Might Do</h2>
            <div className="space-y-6">
              <p>
          ...
          {/* Apply section */}
          <div className="mt-6">
            <p className="mb-6 font-medium italic">Do you have what it takes?</p>
            <div className="flex items-center justify-between">
              {/* Apply button */}
              <button className="btn whitespace-nowrap bg-indigo-500 text-white hover:bg-indigo-600">Apply Today -&gt;</button>
              {/* Share */}
              <div className="flex items-center">
                <div className="mr-4 text-sm italic text-slate-500 dark:text-slate-400">Share:</div>
          ...
          {/* Related Jobs */}
          <div>
            <h2 className="mb-6 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Related Jobs</h2>
