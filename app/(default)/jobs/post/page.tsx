...
import Image06 from "@/app/images/company-icon-01.svg"
import Image03 from "@/app/images/company-icon-03.svg"
import Image04 from "@/app/images/company-icon-07.svg"
import Image05 from "@/app/images/company-icon-08.svg"
    ...
    <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          <div className="mb-2 text-sm italic text-slate-500 dark:text-slate-400">
            Posted Jan 6, 2022
          </div>
          ...
          <div className="mb-6">
            <div className="-m-1 flex flex-wrap items-center">
              <div className="m-1">
                <a
                  className="inline-flex rounded-full bg-indigo-100 px-2.5 py-1 text-center text-xs font-medium text-indigo-600 dark:bg-indigo-500/30 dark:text-indigo-400"
                  href="#0"
                >
                  Full-time
                </a>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <div className="mr-4 text-sm italic text-slate-500 dark:text-slate-400">
                  Share:
                </div>
          ...
          {/* Related Jobs */}
          <div>
            <h2 className="mb-6 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">
              Related Jobs
            </h2>
