...
export default function SortDropdown({
  ...
  return (
    <Menu as="div" className="relative inline-flex">
      ...
      <Transition
        className={`absolute top-full z-10 mt-1 origin-top-right overflow-hidden rounded border border-slate-200 bg-white py-1.5 shadow-lg dark:border-slate-700 dark:bg-slate-800 ${align === 'right' ? 'right-0' : 'left-0'
          }`}
