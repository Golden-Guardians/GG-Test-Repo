  ...
  return (
    <div className="relative h-full bg-white dark:bg-slate-900">
      <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Page header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">Accordion ✨</h1>
        </div>
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          ...
          <div className="mt-8 space-y-8">
            ...
            {/* Basic Accordion */}
            <div>
              <h2 className="mb-6 text-2xl font-bold text-slate-800 dark:text-slate-100">Basic Accordion</h2>
            ...
            <div>
              <h2 className="mb-6 text-2xl font-bold text-slate-800 dark:text-slate-100">Table Row with Accordion</h2>
              {/* Start */}
            ...
            <div>
              <h2 className="mb-6 text-2xl font-bold text-slate-800 dark:text-slate-100">Rich Table Row with Accordion</h2>
              {/* Start */}
              <div className="rounded-sm border border-slate-200 dark:border-slate-700">
                <div className="overflow-x-auto">
                  <table className="w-full table-auto divide-y divide-slate-200 dark:divide-slate-700 dark:bg-slate-800 dark:text-slate-300">
