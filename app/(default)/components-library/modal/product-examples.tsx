...
import AnnouncementIcon from "@/app/images/announcement-icon.svg"
import ModalImage from "@/app/images/modal-image.jpg"
      ...
      <div className="-m-1.5 flex flex-wrap items-center">
        ...
        <div className="m-1.5">
          ...
          >
            ...
            <div className="mb-2 text-center">
              ...
              <div className="mb-3">
                <svg
                  className="inline-flex h-12 w-12 shrink-0 rounded-full fill-current"
                  viewBox="0 0 48 48"
                >
                  <rect
        ...
        <div className="m-1.5">
          ...
          >
            ...
            <div className="mb-5 text-center">
              ...
              <div className="mb-4 inline-flex items-center justify-center space-x-3">
                ...
                <svg width="48" height="48" viewBox="0 0 48 48">
                  <rect
                    className="fill-slate-100 dark:fill-indigo-500/30"
                    width="48"
                    height="48"
                    rx="24"
                  />
            ...
            <div className="mb-5 text-sm">
              <div className="mb-3 font-medium text-slate-800 dark:text-slate-100">
                Golden Guardians would like to:
              </div>
              ...
              <div className="text-xs text-slate-500">
                By clicking on Allow access, you authorize Golden Guardians to
          ...
          <ModalBlank isOpen={newsModalOpen} setIsOpen={setNewsModalOpen}>
            <div className="relative">
              <Image
                ...
                width={460}
                height="200"
                alt="New on Golden Guardians"
              />
              {/* Close button */}
              <button
                className="absolute right-0 top-0 mr-5 mt-5 text-slate-50 hover:text-white"
                onClick={() => {
          ...
          >
            ...
            <div className="px-5 pb-1 pt-4">
              <div className="text-sm">
                        ...
                        <div className="grow">
                          <div className="mb-0.5 flex flex-wrap items-center justify-between">
                            <span className="font-medium text-slate-800 dark:text-slate-100">
                              Golden Guardians Light{" "}
                              <span className="align-top text-xs italic text-slate-500">
                                Current Plan
                              </span>
                            </span>
                        ...
                        <div className="grow">
                          <div className="mb-0.5 flex flex-wrap items-center justify-between">
                            <span className="font-semibold text-slate-800 dark:text-slate-100">
                              Golden Guardians Basic{" "}
                              <span className="align-top text-xs italic text-indigo-500">
                                Best Value ✨
                              </span>
                            </span>
                            <span className="text-slate-600">
                ...
                <div className="text-xs text-slate-500">
                  Your workspace's Golden Guardians Light Plan is set to $39 per
