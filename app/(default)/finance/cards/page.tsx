export const metadata = {
  title: 'Credit Cards - Golden Guardians',
  description: 'Page description',
}

export default function CreditCards() {
  return (
    <div className="bg-white dark:bg-slate-900 lg:relative lg:flex">
      ...
      <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-5 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">Cards ✨</h1>
          </div>
          ...
          <button className="btn bg-indigo-500 text-white hover:bg-indigo-600">
            ...
            <span className="ml-2 hidden xs:block">Add Card</span>
          </button>
        </div>
        ...
        <div className="space-y-2">
          ...
          <label className="relative block w-full cursor-pointer text-left">
            ...
            <div className="rounded border border-slate-200 p-4 shadow-sm duration-150 ease-in-out hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
              <div className="grid grid-cols-12 items-center gap-x-2">
                {/* Card */}
                <div className="order-1 col-span-6 flex items-center space-x-4 sm:order-none sm:col-span-3 lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-3">
                ...
                <div className="order-2 col-span-6 text-left sm:order-none sm:col-span-3 sm:text-center lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                  <div className="truncate text-sm font-medium text-slate-800 dark:text-slate-100">Dominik Lamakani</div>
                </div>
                {/* Card limits */}
                <div className="order-1 col-span-6 text-right sm:order-none sm:col-span-4 sm:text-center lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-4">
                  <div className="text-sm">$780,00 / $20,000</div>
                </div>
                {/* Card status */}
                <div className="order-2 col-span-6 text-right sm:order-none sm:col-span-2 lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                  <div className="inline-flex rounded-full bg-emerald-100 px-2.5 py-1 text-center text-xs font-medium text-emerald-600 dark:bg-emerald-400/30 dark:text-emerald-400">
                    Active
                  </div>
                </div>
              </div>
            ...
            <div
              className="pointer-events-none absolute inset-0 rounded border-2 border-transparent peer-checked:border-indigo-400 dark:peer-checked:border-indigo-500"
              aria-hidden="true"
            />
          </label>
          ...
          <label className="relative block w-full cursor-pointer text-left">
            ...
            <div className="rounded border border-slate-200 p-4 shadow-sm duration-150 ease-in-out hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
              <div className="grid grid-cols-12 items-center gap-x-2">
                ...
                {/* Card status */}
                <div className="order-2 col-span-6 text-right sm:order-none sm:col-span-2 lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                  <div className="inline-flex rounded-full bg-amber-100 px-2.5 py-1 text-center text-xs font-medium text-amber-600 dark:bg-amber-400/30 dark:text-amber-400">
                    Blocked
                  </div>
                </div>
              </div>
      ...
      {/* Sidebar */}
      <div>
        <div className="no-scrollbar border-t border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-gradient-to-b dark:from-slate-800 dark:to-slate-900 lg:sticky lg:top-16 lg:h-[calc(100dvh-64px)] lg:w-[390px] lg:shrink-0 lg:overflow-y-auto lg:overflow-x-hidden lg:border-l lg:border-t-0">
          <div className="px-4 py-8 lg:px-8">
            <div className="mx-auto max-w-sm lg:max-w-none">

              <div className="mb-6 text-center font-semibold text-slate-800 dark:text-slate-100">Physical Metal Card Summary</div>

              {/* Credit Card */}
              <div className="relative aspect-[7/4] overflow-hidden rounded-xl bg-gradient-to-tr from-slate-600 to-slate-800 p-5 shadow-lg">
                {/* Illustration on card */}
                <div className="absolute inset-0 h-full w-full" aria-hidden="true">
                  <svg className="h-full w-full" width="326" height="190" viewBox="0 0 326 190" xmlns="http://www.w3.org/2000/svg">
                    <defs>
              ...
              {/* Details */}
              <div className="mt-6">
                <div className="mb-1 text-sm font-semibold text-slate-800 dark:text-slate-100">Details</div>
                <ul>
                  <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
                    ...
                    <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">Physical Metal Card</div>
                  </li>
                  <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
              ...
              {/* Payment Limits */}
              <div className="mt-6">
                <div className="mb-4 text-sm font-semibold text-slate-800 dark:text-slate-100">Payment Limits</div>
                <div className="border-b border-slate-200 pb-4 dark:border-slate-700">
                  ...
                  <div className="relative h-2 w-full bg-slate-300 dark:bg-slate-700">
              ...
              {/* Withdrawal Limits */}
              <div className="mt-6">
                <div className="mb-4 text-sm font-semibold text-slate-800 dark:text-slate-100">Withdrawal Limits</div>
                <div className="border-b border-slate-200 pb-4 dark:border-slate-700">
                  <div className="mb-2 flex justify-between text-sm">
