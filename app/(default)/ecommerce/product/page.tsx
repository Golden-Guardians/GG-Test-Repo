...
import ProductImage from "@/app/images/product-image.jpg"
...
import User03 from "@/app/images/user-32-03.jpg"
import User04 from "@/app/images/user-32-04.jpg"
import User05 from "@/app/images/user-32-05.jpg"
        ...
        <div>
          ...
          <div className="mb-6 space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0">
            ...
            <div className="flex items-center sm:mr-4">
              ...
              <a
                className="block whitespace-nowrap text-sm font-semibold text-slate-800 dark:text-slate-100"
                href="#0"
              >
                Simona Lürwer
              </a>
          ...
          <div>
            ...
            <p className="mb-6">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua u t
          ...
          <div>
            ...
            <div className="text-center">
              <button className="btn border-slate-200 bg-white text-indigo-500 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                Load More Reviews
              </button>
            </div>
          </div>
