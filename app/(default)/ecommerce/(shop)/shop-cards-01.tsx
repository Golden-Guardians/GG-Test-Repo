import AppImage01 from '@/public/images/applications-image-01.jpeg'
import AppImage02 from '@/public/images/applications-image-02.jpeg'
import AppImage03 from '@/public/images/applications-image-03.jpeg'
import AppImage04 from '@/public/images/applications-image-04.jpeg'
          ...
          <div className="flex grow flex-col p-5">
            ...
            <div className="grow">
              ...
              <header className="mb-3">
                <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">HTML, CSS, JavaScript - Build 6 Creative Projects</h3>
              </header>
              {/* Rating and price */}
              ...
              {/* Features list */}
              <ul className="mb-5 space-y-2 text-sm dark:text-slate-300">
                <li className="flex items-center">
                  <svg className="mr-3 h-4 w-4 shrink-0 fill-current text-slate-400 dark:text-slate-500" viewBox="0 0 16 16">
            ...
            {/* Card footer */}
            <div>
              <a className="btn-sm w-full bg-indigo-500 text-white hover:bg-indigo-600" href="#0">Buy Now</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex grow flex-col p-5">
            ...
            <div className="grow">
              ...
              <div className="mb-4 flex flex-wrap items-center justify-between">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex rounded-full bg-emerald-100 px-2 py-0.5 text-center text-sm font-medium text-emerald-600 dark:bg-emerald-400/30 dark:text-emerald-400">$49.00</div>
                </div>
              </div>
              {/* Features list */}
              <ul className="mb-5 space-y-2 text-sm dark:text-slate-300">
          ...
          <div className="flex grow flex-col p-5">
            ...
            <div className="grow">
              ...
              <div className="mb-4 flex flex-wrap items-center justify-between">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex rounded-full bg-emerald-100 px-2 py-0.5 text-center text-sm font-medium text-emerald-600 dark:bg-emerald-400/30 dark:text-emerald-400">$129.00</div>
                </div>
              </div>
              {/* Features list */}
              <ul className="mb-5 space-y-2 text-sm dark:text-slate-300">
