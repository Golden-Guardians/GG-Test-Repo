import AppImage09 from "@/app/images/applications-image-09.jpg"
import AppImage10 from "@/app/images/applications-image-10.jpg"
import AppImage11 from "@/app/images/applications-image-11.jpg"
import AppImage12 from "@/app/images/applications-image-12.jpg"
            ...
            <div className="grow">
              ...
              <ul className="mb-5 space-y-2 text-sm dark:text-slate-300">
                <li className="flex items-center">
                  <svg
                    className="mr-3 h-4 w-4 shrink-0 fill-current text-slate-400 dark:text-slate-500"
                    viewBox="0 0 16 16"
                  >
