...
import ProductImage01 from '@/public/images/related-product-01.jpeg'
import ProductImage02 from '@/public/images/related-product-02.jpeg'
import ProductImage03 from '@/public/images/related-product-03.jpeg'
        ...
        <div className="lg:mx-auto lg:max-w-[640px]">
          ...
          <div className="mb-6 lg:mb-0">
            ...
            <header className="mb-6">
              {/* Title */}
              <h1 className="mb-2 text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">Thank you for your order ✨</h1>
              <p>You will soon receive a confirmation email with details of your order and a link to download the files.</p>
            </header>
            {/* Billing Information */}
            <div>
              <div className="mb-4 font-semibold text-slate-800 dark:text-slate-100">Billing Information</div>
              <form>
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 md:flex md:space-x-4 md:space-y-0">
                    ...
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-surname">
                        Surname
                      </label>
                  ...
                  <div className="space-y-4 md:flex md:space-x-4 md:space-y-0">
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-address">
                        Address
                      </label>
                      <input id="card-address" className="form-input w-full" type="text" />
                    </div>
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-city">
                        Town/City
                      </label>
                  ...
                  <div className="space-y-4 md:flex md:space-x-4 md:space-y-0">
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-state">
                        State/Country
                      </label>
                      <input id="card-state" className="form-input w-full" type="text" />
                    </div>
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-country">
                  ...
                  <div className="space-y-4 md:flex md:space-x-4 md:space-y-0">
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-postcode">
                        Postcode
                      </label>
                      <input id="card-postcode" className="form-input w-full" type="text" />
                    </div>
                    <div className="flex-1">
                      <label className="mb-1 block text-sm font-medium" htmlFor="card-vat">
                        VAT ID
                      </label>
                  ...
                  <div className="text-right">
                    <button type="submit" className="btn border-slate-200 bg-white text-indigo-500 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                      Download Invoice
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-2 text-center md:flex md:items-center md:justify-between md:space-x-2 md:space-y-0 md:text-left">
                ...
                <div className="relative inline-flex rounded bg-emerald-500 px-3 py-1 text-center">
                  ...
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <span className="text-sm font-medium uppercase text-emerald-50">XMAS22</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="no-scrollbar border-t border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800/20 lg:sticky lg:top-16 lg:h-[calc(100dvh-64px)] lg:w-[320px] lg:shrink-0 lg:overflow-y-auto lg:overflow-x-hidden lg:border-l lg:border-t-0 xl:w-[352px] 2xl:w-[calc(352px+80px)]">
          <div className="px-4 py-8 lg:px-8 2xl:px-12">
            <div className="mx-auto max-w-sm lg:max-w-none">
              <h2 className="mb-6 text-2xl font-bold text-slate-800 dark:text-slate-100">Order Summary</h2>
              <div className="space-y-6">

                {/* Order Details */}
                <div>
                  <div className="mb-2 font-semibold text-slate-800 dark:text-slate-100">Order Details</div>
                  {/* Cart items */}
                  <ul>
                    {/* Cart item */}
                    <li className="flex items-center border-b border-slate-200 py-3 dark:border-slate-700">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium leading-tight text-slate-800 dark:text-slate-100">The Complete Front-End Development Course!</h4>
                        </a>
                      </div>
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">$69</div>
                    </li>
                    {/* Cart item */}
                    <li className="flex items-center border-b border-slate-200 py-3 dark:border-slate-700">
                      <a className="mr-2 block shrink-0 xl:mr-4" href="#0">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium leading-tight text-slate-800 dark:text-slate-100">Web Development Ultimate Course 2021</h4>
                        </a>
                      </div>
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">$69</div>
                    </li>
                    ...
                    <li className="flex items-center border-b border-slate-200 py-3 dark:border-slate-700">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium leading-tight text-slate-800 dark:text-slate-100">Full-Stack JavaScript Course!</h4>
                        </a>
                      </div>
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">$69</div>
                    </li>
                  ...
                  <ul>
                    <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
                      ...
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">$205</div>
                    </li>
                    <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
                      <div className="text-sm">Taxes</div>
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">$48</div>
                    </li>
                    <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
                      ...
                      <div className="ml-2 text-sm font-medium text-slate-800 dark:text-slate-100">-$25</div>
                    </li>
                    <li className="flex items-center justify-between border-b border-slate-200 py-3 dark:border-slate-700">
                      <div className="text-sm">Total</div>
                      <div className="ml-2 text-sm font-medium text-emerald-600">$205</div>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <div className="rounded border border-slate-200 p-3 text-sm dark:border-slate-700">
                    <div className="flex items-center justify-between space-x-2">
                      ...
                      <div className="flex items-center">
                        {/* Mastercard icon */}
                        <svg className="mr-3 shrink-0" width="32" height="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-6">
                  <div className="mb-4">
                    <Link href="/ecommerce/pay" className="btn w-full bg-indigo-500 text-white hover:bg-indigo-600">
                      View Your Order
                    </Link>
                  </div>
