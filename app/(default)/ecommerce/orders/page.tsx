...
import Image01 from "@/app/images/icon-01.svg"
import Image02 from "@/app/images/icon-02.svg"
import Image03 from "@/app/images/icon-03.svg"
      ...
      <div className="mb-8 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="grid grid-flow-col justify-start gap-2 sm:auto-cols-max sm:justify-end">
          ...
          <button className="btn bg-indigo-500 text-white hover:bg-indigo-600">
            ...
            <span className="ml-2 hidden xs:block">Add Order</span>
          </button>
        </div>
      </div>
