  ...
  return (
    <div className="grow">
      ...
      <div className="space-y-6 p-6">
        <div>
          <h2 className="mb-4 text-2xl font-bold text-slate-800 dark:text-slate-100">Give Feedback</h2>
          <div className="text-sm">Our product depends on customer feedback to improve the overall experience!</div>
        </div>

        {/* Rate */}
        <section>
          <h3 className="mb-6 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">How likely would you recommend us to a friend or colleague?</h3>
        ...
        {/* Tell us in words */}
        <section>
          <h3 className="mb-5 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Tell us in words</h3>
          {/* Form */}
