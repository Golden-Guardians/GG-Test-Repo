export default function Task02() {
  return (
    <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-lg dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="mb-1 font-semibold text-slate-800 dark:text-slate-100">User should receive a daily digest email</h2>
        {/* Content */}
        <div>
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="shrink-0 rounded-full border border-slate-200 bg-white p-2 text-indigo-500 transition duration-150 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
