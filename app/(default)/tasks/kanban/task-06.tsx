...
import UserImage01 from '@/public/images/user-28-12.jpeg'
...
export default function Task06() {
  return (
    <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-lg dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Design new diagrams</h2>
        {/* Content */}
        <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="-ml-px flex shrink-0 -space-x-3">
          <a className="block" href="#0">
            <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage01} width={28} height={28} alt="User 12" />
          </a>
          <a className="block" href="#0">
