import UserImage01 from '@/public/images/user-28-07.jpeg'
import UserImage02 from '@/public/images/user-28-11.jpeg'
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="-ml-px flex shrink-0 -space-x-3">
          <a className="block" href="#0">
            <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage01} width={28} height={28} alt="User 07" />
          </a>
          <a className="block" href="#0">
            <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage02} width={28} height={28} alt="User 11" />
          </a>
        </div>
        {/* Right side */}
