import UserImage01 from "@/app/images/user-28-07.jpg"
import UserImage02 from "@/app/images/user-28-11.jpg"
      ...
      <div className="mb-3">
        ...
        <div>
          <div className="text-sm">
            #7764 created by{" "}
            <a className="font-medium text-slate-800 hover:underline" href="#0">
              markus-james
            </a>
          </div>
        </div>
