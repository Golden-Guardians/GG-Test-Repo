import UserImage01 from '@/public/images/user-28-08.jpeg'
...
export default function Task07() {
  return (
    <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-lg dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="mb-1 font-semibold text-slate-800 dark:text-slate-100">Manage internal feedback</h2>
      </div>
      {/* Meta */}
      <div className="flex items-center justify-between">
        ...
        <div className="-ml-px flex shrink-0 -space-x-3">
          <a className="block" href="#0">
            <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage01} width={28} height={28} alt="User 08" />
          </a>
        </div>
        {/* Right side */}
      ...
      <ul className="mt-3">
        <li className="flex items-center border-t border-slate-200 py-2 dark:border-slate-700">
          ...
          <div className="text-sm text-slate-400 line-through dark:text-slate-500">Call with incoming clients</div>
        </li>
        <li className="flex items-center border-t border-slate-200 py-2 dark:border-slate-700">
          <svg className="mr-2 h-3 w-3 shrink-0 fill-current text-emerald-500" viewBox="0 0 12 12">
            <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
          </svg>
          <div className="text-sm text-slate-400 line-through dark:text-slate-500">Manage inbound deals</div>
        </li>
      </ul>
    </div>
  )
