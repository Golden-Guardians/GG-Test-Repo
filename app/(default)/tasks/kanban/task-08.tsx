import TaskImage from '@/public/images/task-image-02.jpeg'
    ...
    <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-lg dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mb-3">
        ...
        <div className="mb-2 flex items-center">
          ...
          <div className="grow">
            <a className="inline-flex text-slate-800 hover:text-slate-900 dark:text-slate-100 dark:hover:text-white" href="#0">
        ...
        <div>
          ...
          <Image className="mt-3 w-full" src={TaskImage} width={259} height={142} alt="Task 02" />
        </div>
      </div>
      {/* Footer */}
