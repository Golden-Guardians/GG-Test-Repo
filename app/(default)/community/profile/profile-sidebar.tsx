        ...
        <div>
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <div className="relative">
                  <div className="flex grow items-center truncate">
                    <Image className="mr-2 h-8 w-8 rounded-full" src={ProfileImage} width={32} height={32} alt="Group 01" />
          ...
          <div className="px-5 py-4">
            ...
            <form className="relative">
              ...
              <input id="profile-search" className="form-input w-full bg-white pl-9 dark:bg-slate-800" type="search" placeholder="Search…" />
            ...
            {/* Team members */}
            <div className="mt-4">
              <div className="mb-3 text-xs font-semibold uppercase text-slate-400 dark:text-slate-500">Team members</div>
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="w-full rounded bg-indigo-500/30 p-2" onClick={() => setFlyoutOpen(false)}>
                ...
                <li className="-mx-2">
                  <button className="w-full rounded p-2" onClick={() => setFlyoutOpen(false)}>
