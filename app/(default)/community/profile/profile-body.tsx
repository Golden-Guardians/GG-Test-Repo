...
import Icon02 from "@/app/images/icon-02.svg"
import Icon03 from "@/app/images/icon-03.svg"
import ProfileBg from "@/app/images/profile-bg.jpg"
import UserAvatar from "@/app/images/user-128-01.jpg"
      ...
      <div className="relative px-4 pb-8 sm:px-6">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex space-x-2 sm:mb-2">
              <button className="shrink-0 rounded border border-slate-200 bg-white p-1.5 shadow-sm hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                <svg
                  className="h-1 w-4 fill-current text-slate-400"
                  viewBox="0 0 16 4"
                >
        ...
        <header className="mb-6 text-center sm:text-left">
          ...
          <div className="mb-2 inline-flex items-start">
            ...
            <svg
              className="ml-2 h-4 w-4 shrink-0 fill-current text-amber-500"
              viewBox="0 0 16 16"
            >
          ...
          <div className="flex flex-wrap justify-center space-x-4 sm:justify-start">
            <div className="flex items-center">
              ...
              <span className="ml-2 whitespace-nowrap text-sm font-medium text-slate-500 dark:text-slate-400">
                Milan, IT
              </span>
            </div>
            <div className="flex items-center">
              ...
              <a
                className="ml-2 whitespace-nowrap text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400"
                href="#0"
              >
                carolinmcneail.com
              </a>
        ...
        <div className="relative mb-6">
          ...
          <ul className="no-scrollbar relative -mx-4 flex flex-nowrap overflow-x-scroll text-sm font-medium sm:-mx-6 lg:-mx-8">
            <li className="mr-6 first:pl-4 last:mr-0 last:pr-4 sm:first:pl-6 sm:last:pr-6 lg:first:pl-8 lg:last:pr-8">
              <a
                className="block whitespace-nowrap border-b-2 border-indigo-500 pb-3 text-indigo-500"
                href="#0"
              >
                General
              </a>
            ...
            <li className="mr-6 first:pl-4 last:mr-0 last:pr-4 sm:first:pl-6 sm:last:pr-6 lg:first:pl-8 lg:last:pr-8">
              <a
                className="block whitespace-nowrap pb-3 text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300"
                href="#0"
              >
                Connections
              </a>
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      ...
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-amber-500">
                        <svg
                          className="h-8 w-8 fill-current text-amber-50"
                          viewBox="0 0 32 32"
                        >
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      ...
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-indigo-500">
                        <svg
                          className="h-8 w-8 fill-current text-indigo-50"
                          viewBox="0 0 32 32"
                        >
