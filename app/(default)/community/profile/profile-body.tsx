...
import ProfileBg from '@/public/images/profile-bg.jpeg'
import UserAvatar from '@/public/images/user-128-01.jpeg'
...
export default function ProfileBody() {
  ...
  return (
    <div
      className={`flex grow flex-col bg-white transition-transform duration-300 ease-in-out dark:bg-slate-900 md:translate-x-0 ${
        flyoutOpen ? 'translate-x-1/3' : 'translate-x-0'
      }`}
    >
      {/* Profile background */}
      <div className="relative h-56 bg-slate-200 dark:bg-slate-900">
        <Image className="h-full w-full object-cover" src={ProfileBg} width={979} height={220} alt="Profile background" />
        {/* Close button */}
        <button
          className="absolute left-4 top-4 text-white opacity-80 hover:opacity-100 sm:left-6 md:hidden"
      ...
      <div className="relative px-4 pb-8 sm:px-6">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex space-x-2 sm:mb-2">
              <button className="shrink-0 rounded border border-slate-200 bg-white p-1.5 shadow-sm hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                <svg className="h-1 w-4 fill-current text-slate-400" viewBox="0 0 16 4">
              ...
              <button className="btn-sm bg-indigo-500 text-white hover:bg-indigo-600">
                <svg className="shrink-0 fill-current" width="11" height="8" viewBox="0 0 11 8">
        ...
        <header className="mb-6 text-center sm:text-left">
          ...
          <div className="mb-2 inline-flex items-start">
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Carolyn McNeail</h1>
            <svg className="ml-2 h-4 w-4 shrink-0 fill-current text-amber-500" viewBox="0 0 16 16">
          ...
          {/* Bio */}
          <div className="mb-3 text-sm">Fitness Fanatic, Design Enthusiast, Mentor, Meetup Organizer & PHP Lover.</div>
          {/* Meta */}
          <div className="flex flex-wrap justify-center space-x-4 sm:justify-start">
            <div className="flex items-center">
              ...
              <span className="ml-2 whitespace-nowrap text-sm font-medium text-slate-500 dark:text-slate-400">Milan, IT</span>
            </div>
            <div className="flex items-center">
              <svg className="h-4 w-4 shrink-0 fill-current text-slate-400 dark:text-slate-500" viewBox="0 0 16 16">
        ...
        <div className="flex flex-col xl:flex-row xl:space-x-16">
          ...
          <div className="mb-8 flex-1 space-y-5 xl:mb-0">
            {/* About Me */}
            <div>
              <h2 className="mb-2 font-semibold text-slate-800 dark:text-slate-100">About Me</h2>
            ...
            {/* Departments */}
            <div>
              <h2 className="mb-2 font-semibold text-slate-800 dark:text-slate-100">Departments</h2>
              {/* Cards */}
              <div className="grid gap-4 xl:grid-cols-2">
                {/* Card */}
                <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                  {/* Card header */}
                  <div className="mb-2 flex grow items-center truncate">
                    <div className="mr-2 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-700">
                  ...
                  {/* Card content */}
                  <div className="mb-3 text-sm">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
                  {/* Card footer */}
                  <div className="flex items-center justify-between">
                    {/* Avatars group */}
                    <div className="-ml-0.5 flex -space-x-3">
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage02} width={24} height={24} alt="Avatar" />
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage03} width={24} height={24} alt="Avatar" />
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage04} width={24} height={24} alt="Avatar" />
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage05} width={24} height={24} alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                ...
                <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                  ...
                  <div className="flex items-center justify-between">
                    {/* Avatars group */}
                    <div className="-ml-0.5 flex -space-x-3">
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage06} width={24} height={24} alt="Avatar" />
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage03} width={24} height={24} alt="Avatar" />
                      <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={UserImage01} width={24} height={24} alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                      <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">
            ...
            {/* Work History */}
            <div>
              <h2 className="mb-2 font-semibold text-slate-800 dark:text-slate-100">Work History</h2>
              <div className="rounded-sm border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      {/* Icon */}
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-amber-500">
                        <svg className="h-8 w-8 fill-current text-amber-50" viewBox="0 0 32 32">
                    ...
                    <div className="mt-2 sm:ml-2 sm:mt-0">
                      <ul className="-m-1 flex flex-wrap sm:justify-end">
                        <li className="m-1">
                          <button className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-2.5 py-0.5 text-xs font-medium leading-5 text-slate-500 shadow-sm duration-150 ease-in-out hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:border-slate-600">
                            Marketing
                          </button>
                        </li>
                        <li className="m-1">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      {/* Icon */}
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-indigo-500">
                        <svg className="h-8 w-8 fill-current text-indigo-50" viewBox="0 0 32 32">
