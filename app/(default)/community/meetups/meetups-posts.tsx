...
import MeetupsThumb01 from '@/public/images/meetups-thumb-01.jpeg'
import MeetupsThumb02 from '@/public/images/meetups-thumb-02.jpeg'
import MeetupsThumb03 from '@/public/images/meetups-thumb-03.jpeg'
import MeetupsThumb04 from '@/public/images/meetups-thumb-04.jpeg'
import MeetupsThumb05 from '@/public/images/meetups-thumb-05.jpeg'
import MeetupsThumb06 from '@/public/images/meetups-thumb-06.jpeg'
import MeetupsThumb07 from '@/public/images/meetups-thumb-07.jpeg'
import MeetupsThumb08 from '@/public/images/meetups-thumb-08.jpeg'
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-2">
      ...
      <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
        {/* Image */}
        <Link className="relative block w-24 shrink-0 sm:w-[14rem] xl:sidebar-expanded:w-40 2xl:sidebar-expanded:w-[14rem]" href="/community/meetups/post">
          <Image
      ...
      <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="flex grow flex-col p-5">
          <div className="grow">
            <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Wed 29 Dec, 2021</div>
            <Link className="mb-2 inline-flex" href="/community/meetups/post">
      ...
      <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="flex grow flex-col p-5">
          <div className="grow">
            <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Mon 3 Jan, 2022</div>
            <Link className="mb-2 inline-flex" href="/community/meetups/post">
          ...
          <div className="mt-3 flex justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium italic text-slate-400 dark:text-slate-500">+117</div>
            </div>
          </div>
        </div>
      </article>
      ...
      <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="flex grow flex-col p-5">
          <div className="grow">
            <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Thu 6 Jan, 2022</div>
            <Link className="mb-2 inline-flex" href="/community/meetups/post">
          ...
          <div className="mt-3 flex justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium italic text-slate-400 dark:text-slate-500">+64</div>
            </div>
          </div>
        </div>
      </article>
        ...
        <div className="flex grow flex-col p-5">
          ...
          <div className="mt-3 flex justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium italic text-slate-400 dark:text-slate-500">+112</div>
            </div>
          </div>
        </div>
      </article>
      ...
      <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="flex grow flex-col p-5">
          <div className="grow">
            <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Fri 7 Jan, 2022</div>
            <Link className="mb-2 inline-flex" href="/community/meetups/post">
          ...
          <div className="mt-3 flex justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium italic text-slate-400 dark:text-slate-500">+32</div>
            </div>
          </div>
        </div>
      </article>
