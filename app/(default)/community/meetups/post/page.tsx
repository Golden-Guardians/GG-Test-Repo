export const metadata = {
  title: 'Meetup Post - Golden Guardians',
...
import MeetupImage from '@/public/images/meetup-image.jpeg'
import MeetupPhoto01 from '@/public/images/meetup-photo-01.jpeg'
import MeetupPhoto02 from '@/public/images/meetup-photo-02.jpeg'
import MeetupPhoto03 from '@/public/images/meetup-photo-03.jpeg'
import MeetupThumb from '@/public/images/meetups-thumb-02.jpeg'
  ...
  return (
    <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          <div className="mb-6">
            <Link className="btn-sm border-slate-200 bg-white px-3 text-slate-600 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600" href="/community/meetups">
              <svg className="mr-2 fill-current text-slate-400 dark:text-slate-500" width="7" height="12" viewBox="0 0 7 12">
                <path d="M5.4.6 6.8 2l-4 4 4 4-1.4 1.4L0 6z" />
              </svg>
              <span>Back To Meetups</span>
            </Link>
          </div>
          <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Mon 27 Dec, 2021 - 9:00 PM -&gt; 10:00 PM</div>
          <header className="mb-4">
            {/* Title */}
            <h1 className="mb-2 text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">The World of AI and Machine Learning — Open Chat</h1>
          ...
          <div className="mb-6 space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0">
            ...
            <div className="flex flex-wrap items-center space-x-2 sm:justify-end">
              {/* Tags */}
              <div className="inline-flex items-center rounded-full bg-white px-2.5 py-1 text-center text-xs font-medium text-slate-600 dark:bg-slate-700 dark:text-slate-400">
                <svg className="mr-2 h-3 w-4 fill-slate-400 dark:fill-slate-500" viewBox="0 0 16 12">
                  <path d="m16 2-4 2.4V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.6l4 2.4V2ZM2 10V2h8v8H2Z" />
                </svg>
                <span>Online Event</span>
              </div>
              <div className="inline-flex rounded-full bg-emerald-100 px-2.5 py-1 text-center text-xs font-medium uppercase text-emerald-600 dark:bg-emerald-400/30 dark:text-emerald-400">
                Free
              </div>
            </div>
          </div>
          ...
          {/* Post content */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Meetup Details</h2>
          ...
          {/* Photos */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Photos (3)</h2>
          ...
          {/* Comments */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Comments (3)</h2>
            <ul className="my-6 space-y-5">
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="mb-2 text-sm font-semibold text-slate-800 dark:text-slate-100">Taylor Nieman</div>
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="mb-2 text-sm font-semibold text-slate-800 dark:text-slate-100">Meagan Loyst</div>
                  <div className="italic">
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam.”
                  </div>
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="mb-2 text-sm font-semibold text-slate-800 dark:text-slate-100">Frank Malik</div>
                  <div className="italic">
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam.”
                  </div>
          ...
          {/* Similar Meetups */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">Similar Meetups</h2>
            <div className="my-6 space-y-8 sm:space-y-5 lg:mb-0">
              ...
              <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
                {/* Image */}
                <a className="relative block w-24 shrink-0 sm:w-[14rem] lg:sidebar-expanded:w-20 xl:sidebar-expanded:w-[14rem]" href="#0">
                  <Image
                ...
                <div className="flex grow flex-col p-5">
                  <div className='grow'>
                    <div className="mb-2 text-sm font-semibold uppercase text-indigo-500">Mon 27 Dec, 2021</div>
                  ...
                  <div className="mt-3 flex justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="-ml-0.5 flex -space-x-3">
                        <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={Avatar02} width={28} height={28} alt="User 02" />
                        <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={Avatar03} width={28} height={28} alt="User 03" />
                        <Image className="box-content rounded-full border-2 border-white dark:border-slate-800" src={Avatar04} width={28} height={28} alt="User 04" />
                      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-sm border border-slate-200 bg-white p-5 shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:w-[18rem] xl:w-[20rem]">
            <div className="space-y-2">
              ...
              <button className="btn w-full border-slate-200 text-slate-600 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600">
                <svg className="h-4 w-4 shrink-0 fill-rose-500" viewBox="0 0 16 16">
          ...
          <div className="rounded-sm border border-slate-200 bg-white p-5 shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:w-[18rem] xl:w-[20rem]">
            <div className="mb-5 flex justify-between space-x-1">
              <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">Attendees (127)</div>
            ...
            <ul className="space-y-3">
                ...
                <div className="flex justify-between">
                  <div className="flex grow items-center">
                    <div className="relative mr-3">
                      <Image className="h-8 w-8 rounded-full" src={UserImage08} width={32} height={32} alt="User 08" />
                    </div>
              ...
              <li>
                <div className="flex justify-between">
                  <div className="flex grow items-center">
                    <div className="relative mr-3">
                      <Image className="h-8 w-8 rounded-full" src={UserImage03} width={32} height={32} alt="User 03" />
                    </div>
                    <div className="truncate">
          ...
          <div className="rounded-sm border border-slate-200 bg-white p-5 shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:w-[18rem] xl:w-[20rem]">
            <div className="mb-5 flex justify-between space-x-1">
              <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">Invite Friends</div>
              <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">
                View All
              </a>
            </div>
            <ul className="space-y-3">
              ...
              <li>
                <div className="flex items-center justify-between">
                  <div className="flex grow items-center">
                    <div className="relative mr-3">
                      <Image className="h-8 w-8 rounded-full" src={UserImage06} width={32} height={32} alt="User 06" />
                    </div>
                    <div className="truncate">
                      <span className="text-sm font-medium text-slate-800 dark:text-slate-100">Carolyn McNeail</span>
                    </div>
