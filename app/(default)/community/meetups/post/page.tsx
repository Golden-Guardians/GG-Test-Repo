...
import MeetupImage from "@/app/images/meetup-image.jpg"
import MeetupPhoto01 from "@/app/images/meetup-photo-01.jpg"
import MeetupPhoto02 from "@/app/images/meetup-photo-02.jpg"
import MeetupPhoto03 from "@/app/images/meetup-photo-03.jpg"
import MeetupThumb from "@/app/images/meetups-thumb-02.jpg"
    ...
    <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          <div className="mb-6">
            <Link
              className="btn-sm border-slate-200 bg-white px-3 text-slate-600 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600"
              href="/community/meetups"
            >
              <svg
                className="mr-2 fill-current text-slate-400 dark:text-slate-500"
                width="7"
                height="12"
                viewBox="0 0 7 12"
              >
          ...
          {/* Post content */}
          <div>
            <h2 className="mb-2 text-xl font-bold leading-snug text-slate-800 dark:text-slate-100">
              Meetup Details
            </h2>
            <p className="mb-6">
          ...
          <div>
            ...
            <div className="my-6 space-y-8 sm:space-y-5 lg:mb-0">
              ...
              <article className="flex overflow-hidden rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
                {/* Image */}
                <a
                  className="relative block w-24 shrink-0 sm:w-[14rem] lg:sidebar-expanded:w-20 xl:sidebar-expanded:w-[14rem]"
                  href="#0"
                >
                  <Image
