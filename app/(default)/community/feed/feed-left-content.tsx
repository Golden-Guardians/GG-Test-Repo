      ...
      <div className="no-scrollbar md:sticky md:top-16 md:h-[calc(100dvh-64px)] md:overflow-y-auto md:overflow-x-hidden">
        <div className="md:py-8">
          ...
          <header className="mb-6">
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 md:text-3xl">Feed ✨</h1>
          </header>
          ...
          <div className="mb-6 xl:hidden">
            <form className="relative">
              ...
              <input id="feed-search-mobile" className="form-input w-full bg-white pl-9 dark:bg-slate-800" type="search" placeholder="Search…" />
