export const metadata = {
  title: 'Feed - Golden Guardians',
  description: 'Page description',
}

import Avatar from '@/public/images/user-40-02.jpeg'
              ...
              <div className="space-y-4">
                ...
                <div className="rounded border border-slate-200 bg-white p-5 shadow-md dark:border-slate-700 dark:bg-slate-800">
                  <div className="mb-5 flex items-center space-x-3">
                    <Image className="shrink-0 rounded-full" src={Avatar} width={40} height={40} alt="User 02" />
                    <div className="grow">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex grow space-x-5">
                      <button className="inline-flex items-center text-sm font-medium text-slate-600 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-200">
                        <svg className="mr-2 h-4 w-4 fill-indigo-400" xmlns="http://www.w3.org/2000/svg">
