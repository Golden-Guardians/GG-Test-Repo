      ...
      <div className="flex h-full flex-col">
          ...
          <div className="flex items-start justify-between">
            ...
            <header>
              <div className="mb-2 flex">
                <Link className="relative mr-5 inline-flex items-start" href={user.link}>
                ...
                <div className="mt-1 pr-1">
                  ...
                  <div className="flex items-center"><span className="-mt-0.5 mr-1 text-sm font-medium text-slate-400">-&gt;</span> <span>{user.location}</span></div>
                </div>
              </div>
            </header>
            {/* Menu button */}
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          <div className="flex divide-x divide-slate-200 dark:divide-slate-700">
            <Link className="block flex-1 px-3 py-4 text-center text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="/messages">
            ...
            <Link className="group block flex-1 px-3 py-4 text-center text-sm font-medium text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-200" href="/settings/account">
              <div className="flex items-center justify-center">
                <svg className="mr-2 h-4 w-4 shrink-0 fill-current text-slate-400 group-hover:text-slate-500 dark:text-slate-600" viewBox="0 0 16 16">
