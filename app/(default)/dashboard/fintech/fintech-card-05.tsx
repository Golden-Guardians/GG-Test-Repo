          ...
          <table className="w-full table-auto dark:text-slate-300">
            ...
            <tbody className="divide-y divide-slate-100 text-sm dark:divide-slate-700">
              ...
              <tr>
                ...
                <td className="whitespace-nowrap p-2">
                  <div className="text-right font-medium text-slate-800 dark:text-slate-100">-$1,299.22</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="whitespace-nowrap p-2">
                  <div className="flex items-center">
                    <div className="mr-2 shrink-0 rounded-full bg-slate-900 sm:mr-3">
                ...
                <td className="whitespace-nowrap p-2">
                  <div className="text-right font-medium text-slate-800 dark:text-slate-100">-$272.88</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="whitespace-nowrap p-2">
                  <div className="text-right font-medium text-slate-800 dark:text-slate-100">-$999.44</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="whitespace-nowrap p-2">
                  <div className="text-right font-medium text-slate-800 dark:text-slate-100">-$1,029.77</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="whitespace-nowrap p-2">
                  <div className="text-right font-medium text-slate-800 dark:text-slate-100">-$1,921.26</div>
                </td>
              </tr>
            </tbody>
          </table>
