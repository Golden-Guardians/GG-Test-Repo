        ...
        <div className="overflow-x-auto">
          <table className="w-full table-auto dark:text-slate-300">
            ...
            <thead className="rounded-sm bg-slate-50 text-xs uppercase text-slate-400 dark:bg-slate-700 dark:bg-opacity-50 dark:text-slate-500">
              <tr>
                <th className="whitespace-nowrap p-2">
                  <div className="text-left font-semibold">Market</div>
                </th>
                <th className="whitespace-nowrap p-2">
                  <div className="text-left font-semibold">Mkt Cap</div>
                </th>
                <th className="whitespace-nowrap p-2">
                  <div className="text-left font-semibold">Chart</div>
                </th>
                <th className="whitespace-nowrap p-2">
                  <div className="text-left font-semibold">Price</div>
                </th>
                <th className="whitespace-nowrap p-2">
                  <div className="text-left font-semibold">Chg. (24h)</div>
                </th>
              </tr>
            </thead>
            {/* Table body */}
            <tbody className="divide-y divide-slate-100 text-sm font-medium dark:divide-slate-700">
              {/* Row */}
              <tr>
                <td className="whitespace-nowrap p-2 md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="uppercase text-slate-800 dark:text-slate-100">Twtr</div>
                      <div className="text-xs text-slate-500">Twitter Inc.</div>
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap p-2">
                  <div className="text-left font-normal">33.94B</div>
                </td>
                <td className="whitespace-nowrap p-2">
              ...
              <tr>
                <td className="whitespace-nowrap p-2 md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="uppercase text-slate-800 dark:text-slate-100">Fb</div>
                      <div className="text-xs text-slate-500">Meta Inc.</div>
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap p-2">
                  <div className="text-left font-normal">903.71B</div>
                </td>
                <td className="whitespace-nowrap p-2">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
              ...
              <tr>
                <td className="whitespace-nowrap p-2 md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="uppercase text-slate-800 dark:text-slate-100">Googl</div>
                      <div className="text-xs text-slate-500">Alphabet Inc.</div>
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap p-2">
                  <div className="text-left font-normal">1.70T</div>
                </td>
                <td className="whitespace-nowrap p-2">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
              ...
              <tr>
                <td className="whitespace-nowrap p-2 md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="uppercase text-slate-800 dark:text-slate-100">Aapl</div>
                      <div className="text-xs text-slate-500">Apple Inc.</div>
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap p-2">
                  <div className="text-left font-normal">2.77T</div>
                </td>
                <td className="whitespace-nowrap p-2">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
              ...
              <tr>
                <td className="whitespace-nowrap p-2 md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="uppercase text-slate-800 dark:text-slate-100">Coin</div>
                      <div className="text-xs text-slate-500">Coinbase Global Inc.</div>
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap p-2">
                  <div className="text-left font-normal">50.89B</div>
                </td>
                <td className="whitespace-nowrap p-2">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
