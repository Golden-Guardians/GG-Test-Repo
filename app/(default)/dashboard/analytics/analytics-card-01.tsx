...
export default function AnalyticsCard01() {
  ...
  return(
    <div className="col-span-full flex flex-col rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800 xl:col-span-8">
      ...
      <div className="px-5 py-1">
        <div className="flex flex-wrap">
          ...
          <div className="flex items-center py-2">
            <div className="mr-5">
              <div className="flex items-center">
                <div className="mr-2 text-3xl font-bold text-slate-800 dark:text-slate-100">24.7K</div>
            ...
            <div className="mr-5 hidden h-8 w-px bg-slate-200 dark:bg-slate-700 md:block" aria-hidden="true"></div>
          </div>
          {/* Total Pageviews */}
          <div className="flex items-center py-2">
            <div className="mr-5">
              <div className="flex items-center">
                <div className="mr-2 text-3xl font-bold text-slate-800 dark:text-slate-100">56.9K</div>
          ...
          <div className="flex items-center py-2">
            <div className="mr-5">
              <div className="flex items-center">
                <div className="mr-2 text-3xl font-bold text-slate-800 dark:text-slate-100">54%</div>
          ...
          <div className="flex items-center">
            <div>
              <div className="flex items-center">
                <div className="mr-2 text-3xl font-bold text-slate-800 dark:text-slate-100">2m 56s</div>
                <div className="text-sm font-medium text-amber-500">+7%</div>
              </div>
