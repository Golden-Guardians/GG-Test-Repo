  ...
  return(
    <div className="col-span-full rounded-sm border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800 xl:col-span-6">
      ...
      <div className="p-3">
        ...
        {/* "Yesterday" group */}
        <div>
          <header className="rounded-sm bg-slate-50 p-2 text-xs font-semibold uppercase text-slate-400 dark:bg-slate-700 dark:bg-opacity-50 dark:text-slate-500">Yesterday</header>
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
