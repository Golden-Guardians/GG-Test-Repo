export const metadata = {
  title: "Tell us about your company - Golden Guardians",
          ...
          <div className="flex h-full min-h-[100dvh] flex-col after:flex-1">
            ...
            <div className="px-4 py-8">
              <div className="mx-auto max-w-md">
                ...
                <h1 className="mb-6 text-3xl font-bold text-slate-800 dark:text-slate-100">Tell us about your company ✨</h1>
                {/* Form */}
                <form>
                  <div className="mb-8 space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
                    <label className="relative block flex-1 cursor-pointer">
                      <input type="radio" name="radio-buttons" className="peer sr-only" defaultChecked />
                      <div className="h-full rounded border border-slate-200 bg-white px-4 py-6 text-center shadow-sm duration-150 ease-in-out hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                        <svg className="mb-2 inline-flex h-10 w-10 shrink-0 fill-current" viewBox="0 0 40 40">
                        ...
                        <div className="mb-1 font-medium text-slate-800 dark:text-slate-100">Individual</div>
                    ...
                    <label className="relative block flex-1 cursor-pointer">
                      ...
                      <div className="h-full rounded border border-slate-200 bg-white px-4 py-6 text-center shadow-sm duration-150 ease-in-out hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
                        ...
                        <div className="mb-1 font-medium text-slate-800 dark:text-slate-100">Organization</div>
                        <div className="text-sm">Lorem ipsum is place text commonly used.</div>
                      </div>
                      <div className="pointer-events-none absolute inset-0 rounded border-2 border-transparent peer-checked:border-indigo-400 dark:peer-checked:border-indigo-500" aria-hidden="true"></div>
                    </label>
                  ...
                  <div className="mb-8 flex items-center justify-between space-x-6">
                    <div>
                      <div className="mb-1 text-sm font-medium text-slate-800 dark:text-slate-100">💸 Lorem ipsum is place text commonly?</div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link className="btn ml-auto bg-indigo-500 text-white hover:bg-indigo-600" href="/onboarding-03">Next Step -&gt;</Link>
                  </div>
                </form>
