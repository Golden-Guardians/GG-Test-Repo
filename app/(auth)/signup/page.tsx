export const metadata = {
  title: 'Sign Up - Golden Guardians',
            ...
            <div className="mx-auto w-full max-w-sm px-4 py-8">
              ...
              <form>
                <div className="space-y-4">
                  <div>
                    <label className="mb-1 block text-sm font-medium" htmlFor="email">Email Address <span className="text-rose-500">*</span></label>
                    <input id="email" className="form-input w-full" type="email" />
                  </div>
                  <div>
                    <label className="mb-1 block text-sm font-medium" htmlFor="name">Full Name <span className="text-rose-500">*</span></label>
                    <input id="name" className="form-input w-full" type="text" />
                  </div>
                  <div>
                    <label className="mb-1 block text-sm font-medium" htmlFor="role">Your Role <span className="text-rose-500">*</span></label>
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <Link className="btn ml-3 whitespace-nowrap bg-indigo-500 text-white hover:bg-indigo-600" href="/">Sign Up</Link>
                </div>
              </form>
              {/* Footer */}
