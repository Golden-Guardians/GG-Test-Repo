...
import PayBg from "@/app/images/pay-bg.jpg"
import User from "@/app/images/user-64-13.jpg"
  ...
  return (
    <main>
      <div className="relative pt-8">
        ...
        >
          <Image
            className="h-full w-full object-cover opacity-10 blur"
            src={PayBg}
            width={460}
            height={180}
            alt="Pay background"
      ...
      <div className="relative mx-auto max-w-lg px-4 pb-8 sm:px-6 lg:px-8">
        <div className="rounded-b bg-white px-8 pb-6 shadow-lg dark:bg-slate-800">
          ...
          <div className="mb-6 text-center">
            ...
            <h1 className="mb-2 text-xl font-semibold leading-snug text-slate-800 dark:text-slate-100">
              Front-End Learning 🔥
            </h1>
          ...
          <div className="mb-6 flex justify-center">
            <div className="relative flex w-full rounded bg-slate-50 p-1 dark:bg-slate-700/30">
              ...
              >
                <span
                  className={`absolute inset-0 w-1/2 rounded border border-slate-200 bg-white shadow-sm transition duration-150 ease-in-out dark:border-slate-600 dark:bg-slate-700 ${
                    card ? "translate-x-0" : "translate-x-full"
                  }`}
                ></span>
              </span>
              <button
                className={`relative flex-1 p-1 text-sm font-medium duration-150 ease-in-out ${
                  card ? "text-slate-100" : ""
                }`}
                onClick={(e) => {
                  e.preventDefault()
