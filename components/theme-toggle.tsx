...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80" htmlFor="light-switch">
        <svg className="h-4 w-4 dark:hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="hidden h-4 w-4 dark:block" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
