    ...
    <>
      {open &&
        <div className={className} role="alert">
          <div className="inline-flex min-w-[20rem] rounded-sm border border-slate-200 bg-white px-4 py-2 text-sm text-slate-600 shadow-lg dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">
            <div className="flex w-full items-start justify-between">
              ...
              <button className="ml-3 mt-[3px] opacity-70 hover:opacity-80 dark:text-slate-400" onClick={() => setOpen(false)}>
