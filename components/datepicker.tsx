...
export default function Datepicker({ align }: {
  ...
  return (
    <div className="relative">
      <Flatpickr className="form-input w-[15.5rem] pl-9 font-medium text-slate-500 hover:text-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:text-slate-200" options={options} />
