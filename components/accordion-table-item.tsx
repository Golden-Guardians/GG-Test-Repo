  ...
  return (
    <tbody className="text-sm">
      <tr>
        ...
        <td className="whitespace-nowrap px-2 py-3 first:pl-5 last:pr-5">
          <div className="inline-flex rounded-full bg-amber-100 px-2.5 py-0.5 text-center font-medium text-amber-600 dark:bg-amber-400/30 dark:text-amber-400">{item.status}</div>
        </td>
        <td className="whitespace-nowrap px-2 py-3 first:pl-5 last:pr-5">
