      ...
      {({ open }) => (
        <>
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="px-4 pb-2 pt-1.5 text-xs font-semibold uppercase text-slate-400 dark:text-slate-500">Notifications</div>
            <Menu.Items as="ul" className="focus:outline-none">
              <Menu.Item as="li" className="border-b border-slate-200 last:border-0 dark:border-slate-700">
                {({ active }) => (
                  <Link className={`block px-4 py-2 ${active && 'bg-slate-50 dark:bg-slate-700/20'}`} href="#0">
