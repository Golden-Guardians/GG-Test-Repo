...
export default function Tooltip({
  ...
  return (
    ...
    >
      ...
      <div className={`absolute z-10 ${positionOuterClasses(position)}`}>
        <Transition
          show={tooltipOpen}
          as="div"
          className={`overflow-hidden rounded border shadow-lg ${sizeClasses(size)} ${colorClasses(bg)} ${positionInnerClasses(position)}`}
