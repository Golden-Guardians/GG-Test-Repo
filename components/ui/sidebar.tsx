        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('dashboard') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="ml-2 flex shrink-0">
                            <svg className={`ml-1 h-3 w-3 shrink-0 fill-current text-slate-400 ${open && 'rotate-180'}`} viewBox="0 0 12 12">
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('ecommerce') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('community') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('finance') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('jobs') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('tasks') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                              ...
                              />
                              <path className={`fill-current ${segments.includes('tasks') ? 'text-indigo-500' : 'text-slate-600'}`} d="M1 1h22v23H1z" />
                              <path
              ...
              {/* Messages */}
              <li className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('messages') && 'bg-slate-900'}`}>
                <SidebarLink href="/messages">
                  <div className="flex items-center justify-between">
                    ...
                    {/* Badge */}
                    <div className="ml-2 flex shrink-0">
                      <span className="inline-flex h-5 items-center justify-center rounded bg-indigo-500 px-2 text-xs font-medium text-white">4</span>
                    </div>
                  </div>
                </SidebarLink>
              </li>
              {/* Inbox */}
              <li className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('inbox') && 'bg-slate-900'}`}>
              ...
              {/* Calendar */}
              <li className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('calendar') && 'bg-slate-900'}`}>
              ...
              {/* Campaigns */}
              <li className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('campaigns') && 'bg-slate-900'}`}>
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('settings') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('utility') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${segments.includes('components-library') ? 'hover:text-slate-200' : 'hover:text-white'
                          }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
